      ...
      <a href="<?= site_url('/detail/' . $b['id']) ?>" class="text-decoration-none text-dark">
        <div class="news-card p-3 border bg-light rounded-4 d-flex">
          ...
          <div class="news-content">
            ...
            <p class="waktu"><?= time_elapsed_string($b['created_at']) ?></p>
          </div>
        </div>
      </a>
    </div>
...
<?php if ($hasilProgram): ?>
  <h4>Program</h4>
  <?php foreach ($hasilProgram as $p): ?>
    <div class="col-12">
      <a href="<?= esc($p['link']) ?>" target="_blank" class="text-decoration-none text-dark">
        <div class="news-card p-3 border bg-light rounded-4 d-flex">
          <img src="<?= base_url('upload/' . $p['foto']) ?>" alt="Program" class="berita rounded-4">
          <div class="news-content">
            <h4 class="judul-berita"><?= esc($p['judul']) ?></h4>
            <p class="waktu"><?= time_elapsed_string($p['created_at']) ?></p>
          </div>
        </div>
      </a>
    </div>
...
<?php if ($hasilHistoria): ?>
  <h4>Historia</h4>
  <?php foreach ($hasilHistoria as $h): ?>
    <div class="col-12">
      <a href="<?= site_url('/detail_his/' . $h['id']) ?>" class="text-decoration-none text-dark">
        <div class="news-card p-3 border bg-light rounded-4 d-flex">
          <img src="<?= base_url('upload/' . $h['foto']) ?>" alt="Historia" class="berita rounded-4">
          <div class="news-content">
            <h4 class="judul-berita"><?= esc($h['judul']) ?></h4>
            <p class="waktu"><?= time_elapsed_string($h['created_at']) ?></p>
          </div>
        </div>
      </a>
    </div>
...
<?php if ($hasilLifestyle): ?>
  <h4>Lifestyle</h4>
  <?php foreach ($hasilLifestyle as $l): ?>
    <div class="col-12">
      <a href="<?= site_url('/detail_l/' . $l['id']) ?>" class="text-decoration-none text-dark">
        <div class="news-card p-3 border bg-light rounded-4 d-flex">
          <img src="<?= base_url('upload/' . $l['foto']) ?>" alt="Lifestyle" class="berita rounded-4">
          <div class="news-content">
            <h4 class="judul-berita"><?= esc($l['judul']) ?></h4>
            <p class="waktu"><?= time_elapsed_string($l['created_at']) ?></p>
          </div>
        </div>
      </a>
    </div>
...
<?php if (!$hasilBerita && !$hasilProgram && !$hasilHistoria && !$hasilLifestyle): ?>
