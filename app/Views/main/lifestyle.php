                ...
                <div class="row g-2">
                  <div class="col-12">
                    <div class="category-buttons d-flex flex-wrap gap-3">
                      <a href="<?= site_url('/wisata') ?>" class="btn-category <?= (current_url() == site_url('/wisata')) ? 'active' : ''?>">Wisata</a>
                      <a href="<?= site_url('/hiburan') ?>" class="btn-category <?= (current_url() == site_url('/hiburan')) ? 'active' : ''?>">Hiburan</a>
                      <a href="<?= site_url('/kesehatan') ?>" class="btn-category <?= (current_url() == site_url('/kesehatan')) ? 'active' : ''?>">Kesehatan</a>
                      <a href="<?= site_url('/tips') ?>" class="btn-category <?= (current_url() == site_url('/tips')) ? 'active' : ''?>">Tips & Trik</a>
                    </div>
                  </div>
                </div>
              </div>
