                ...
                <div class="row g-2">
                  <div class="col-12">
                    <div class="category-buttons d-flex flex-wrap gap-3">
                      <a href="<?= site_url('/berita_pkl') ?>" class="btn-category <?= (current_url() == site_url('/berita_pkl')) ? 'active' : ''?>">Kota Pekalongan</a>
                      <a href="<?= site_url('/berita_jateng') ?>" class="btn-category <?= (current_url() == site_url('/berita_jateng')) ? 'active' : ''?>">Jawa Tengah</a>
                      <a href="<?= site_url('/berita_nasional') ?>" class="btn-category <?= (current_url() == site_url('/berita_nasional')) ? 'active' : ''?>">Nasional</a>
                      <a href="<?= site_url('/berita_internasional') ?>" class="btn-category <?= (current_url() == site_url('/berita_internasional')) ? 'active' : ''?>">Internasional</a>
                      <a href="<?= site_url('/berita_olahraga') ?>" class="btn-category <?= (current_url() == site_url('/berita_olahraga')) ? 'active' : ''?>">Olahraga</a>
                    </div>
                  </div>
                </div>
              </div>
